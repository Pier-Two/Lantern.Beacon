...
namespace Lantern.Beacon.Networking.Libp2pProtocols.TcpProtocol;

public class TcpProtocol(IPeerState peerState, ILoggerFactory? loggerFactory = null) : IProtocol
{
    private readonly ILogger? _logger = loggerFactory?.CreateLogger<TcpProtocol>();
