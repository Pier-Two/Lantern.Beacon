...
public class Bytes20 : IEquatable<Bytes20>
{
    ...
    public static explicit operator Bytes20(byte[] bytes) => new(bytes);

    public static explicit operator Bytes20(Span<byte> span) => new(span);

    public static explicit operator Bytes20(ReadOnlySpan<byte> span) => new(span);
